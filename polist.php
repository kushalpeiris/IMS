...
{
if ($tfac=='')
echo "<script> alert ('Please enter division')</script>";
if ($tdept=='')
echo "<script> alert ('Please enter unit')</script>";
if ($titype=='')
echo "<script> alert ('Please enter item type')</script>";
if ($tdd=='')
...
header("location:rptpolist.php?id1=". $tfaccode."&id2=".$tdeptcode."&id3=".$tprogramcode."&id4=".$titypecode."&id5=".$fdate."&id6=".$tdate);
}
?>
...
?>
      ...
      <tr>
        ...
        <td><select name="lstitype" id="lstitype" class="styleselect1" onchange="submit()">
      ...
      <tr>
        <td></td><td>From</td>
        <td><strong>
          <select name="lstfdd" id="lstfdd" class="styleselect1" onchange="submit()">
	 ...
	 {echo '<option>'.$i.'</option>';
      ...
      <tr>
        ...
        <td height="28"><select name="lsttdd" id="lsttdd" class="styleselect1" onchange="submit()">
	...
	//	 echo '<option>'.'-mm-'.'</option>';
	 ...
	 {echo '<option>'.$i.'</option>';
      ...
      <tr>
        <td height="28" colspan="4" style="padding-left:415px"><input name="btnprint" type="submit" id="btnprint" value="Print" class="btn2"/>
        <input name="btnClear" type="submit" class="btn2" id="btnClear" value="Clear" /></td>
      </tr>
    </table>
</form>
</body>
