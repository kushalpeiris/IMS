...
<table width="75%" border="0" id="cmd" style="background-color:lightblue;" align="center">				
				...
				<tr>
					...
					<td width="15%"><select name="lstYear" id="lstYear" onchange="submit()" >
                              ...
                              <td width="15%" align="right">Supplier&nbsp;&nbsp;&nbsp;</td>
								<td class="style31"><select name="lstSupplier" id="lstSupplier" onChange="submit()">
				...
				<tr>
					...
					<td height="100%" colspan="2"><span class="style31">PO no.<span">
					  <select name='lstPO' id="lstPO" style="width:50%;" onChange="submit()">
                        <option value="0">Select... </option>
                        <?php
			...
			<table border="1" width="100%">
			  <tr>
				...
				<tr>
				  <td colspan="2">&nbsp;</td>
				  <td colspan="7">&nbsp;</td>
				  <td  class="style28"><strong><?php if($lstLOF !="F"){?>Grand <?php } ?> Total</strong></td>
				  <td><input name="txtGTot" type="text" readonly="readonly" id="txtGTot" size="10%" onclick="calcTot(<?php echo $i;?>)" /></td>
			  </tr>
              <?php if($lstLOF =="F"){?>
              <tr>
				  <td colspan="13" bgcolor="#CCCCCC" style="color:#FFF"><span class="style31"> Foreign Suppliers Only</span></td>
			  </tr>
				</table></td>
				  <td  class="style28"><strong>Total<?php echo '['.$pocur.']'; ?></strong></td>
				  <td><input type="text" name="txtFrTot" id="txtFrTot" size="10%" readonly="readonly" /></td>
			  </tr>
				<tr>
				  <td  class="style28"><strong>Total [LKR]</strong></td>
